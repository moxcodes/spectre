 ...
 * example, if processor 1 may receive half its elements from block 0 and half
 ...
 * connected cluster.
 *
 * The assignment of portions of blocks to may take partial blocks, and/or
 * multiple blocks to ensure an even distribution of elements to processors.
