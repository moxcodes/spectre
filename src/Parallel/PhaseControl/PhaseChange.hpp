...
/// `PhaseChange::arbitrate_phase_control` function.
enum ArbitrationStrategy {
  ...
  /// requests, potentially replacing the this request.
  ///
 ...
 *
 * There are two primary parts for the phase control flow:
 *
 ...
 * void initialize_phase_change_decision_data_impl(
 ...
 * void contribtue_phase_data_impl(
 ...
 *   in `arbitrate_phase_control_impl` to the Main chare via function
  ...
  arbitrate_phase_control(
    ...
    return call_with_dynamic_type<
        ...
        this, [&current_phase, &phase_change_decision_data,
          ...
          return phase_change->arbitrate_phase_control_impl(
  ...
  void initialize_phase_change_decision_data(
    ...
    return call_with_dynamic_type<void, creatable_classes>(
        this, [&phase_change_decision_data](
          ...
          return phase_change->initialize_phase_change_decision_data_impl(
              phase_change_decision_data);
        });
  }
};
