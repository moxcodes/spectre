...
static auto merge_into_databox_helper(
    db::DataBox<DbTags>&& box, tmpl::list<SimpleTags...> /*meta*/,
...
/*!
 * \brief Merge into the \ref DataBoxGroup "DataBox" the collection of tags
 * requested for initialization in any of the actions.
 *
