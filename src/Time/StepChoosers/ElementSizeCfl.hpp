...
template <size_t Dim, typename System, typename StepChooserRegistrars>
class ElementSizeCfl;

namespace Registrars {
template <size_t Dim, typename System>
struct ElementSizeCfl {
  template <typename StepChooserRegistrars>
  using f = StepChoosers::ElementSizeCfl<Dim, System, StepChooserRegistrars>;
};
}  // namespace Registrars
...
///
/// This is useful as a coarse estimate for slabs, or to place a seiling on
/// another dynamically-adjusted step chooser.
template <size_t Dim, typename System,
          typename StepChooserRegistrars =
              tmpl::list<Registrars::ElementSizeCfl<Dim, System>>>
class ElementSizeCfl : public StepChooser<StepChooserRegistrars> {
 public:
  /// \cond
...
template <size_t Dim, typename System, typename StepChooserRegistrars>
PUP::able::PUP_ID
    ElementSizeCfl<Dim, System, StepChooserRegistrars>::my_PUP_ID =
        0;  // NOLINT
/// \endcond
}  // namespace StepChoosers
