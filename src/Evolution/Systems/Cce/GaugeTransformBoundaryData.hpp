...
struct ComputeGaugeAdjustedBoundaryValue<Tags::BondiR> {
  ...
  using argument_tags =
      tmpl::list<Tags::CauchyAngularCoords, Tags::GaugeOmegaCD,
  ...
  static void apply(
    ...
    interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*r)), l_max)
            .data());
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::DuRDividedByR> {
  ...
  static void apply(
    ...
    interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*du_r_divided_by_r)),
            l_max)
            .data());
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::BondiJ> {
  ...
  static void apply(
    ...
    ComplexModalVector goldberg_modes_j =
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*j)), l_max)
            .data();
    Parallel::printf("J boundary computation check:\n");
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::Dr<Tags::BondiJ>> {
  ...
  static void apply(
    ...
    interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*dr_j)), l_max)
            .data());
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::BondiBeta> {
  ...
  static void apply(
    ...
    interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*beta)), l_max)
            .data());
    ...
    ComplexModalVector goldberg_modes_beta =
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1,
                                           get(*evolution_gauge_beta)),
            l_max)
            .data();
    Parallel::printf("Beta boundary computation check:\n");
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::BondiQ> {
  ...
  static void apply_impl(
    ...
    interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, *dr_u), l_max)
            .data());
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::BondiU> {
  ...
  static void apply(
    ...
    interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*u)), l_max)
            .data());
 ...
 private:
  static void apply_impl(
    ...
    w_interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, *w), l_max)
            .data());
    ...
    u_interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, *boundary_u), l_max)
            .data());
    ...
    *evolution_gauge_w =
    ...
    ComplexModalVector goldberg_modes_w =
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, *evolution_gauge_w), l_max)
            .data();
    Parallel::printf("W boundary computation check:\n");
    Parallel::printf("%e, %e ; %e %e\n", real(goldberg_modes_w[6]),
                     imag(goldberg_modes_w[6]), real(goldberg_modes_w[8]),
                     imag(goldberg_modes_w[8]));
...
struct ComputeGaugeAdjustedBoundaryValue<Tags::BondiH> {
  ...
  static void apply_impl(
    ...
    h_interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, *spec_h), l_max)
            .data());
    ...
    *h_tilde =
    ...
    ComplexModalVector goldberg_modes_h =
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, *h_tilde), l_max)
            .data();
    Parallel::printf("H boundary computation check:\n");
...
struct GaugeUpdateU {
  ...
  static void apply(
    ...
    ComplexModalVector goldberg_modes_u0 =
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*u_0)), l_max)
            .data();
    Parallel::printf("U0 check:\n");
    Parallel::printf("%e, %e ; %e %e\n", real(goldberg_modes_u0[6]),
                     imag(goldberg_modes_u0[6]), real(goldberg_modes_u0[8]),
                     imag(goldberg_modes_u0[8]));
...
//     get<0>(cartesian_x_of_x_tilde); SpinWeighted<ComplexDataVector, 0> y;
//     y.data() = std::complex<double>(1.0, 0.0) *
//     get<1>(cartesian_x_of_x_tilde); SpinWeighted<ComplexDataVector, 0> z;
//     z.data() = std::complex<double>(1.0, 0.0) *
//     get<2>(cartesian_x_of_x_tilde);
...
//     // Unfortunately, this is the best way I can think of to guarantee that
//     // these derivatives are correctly evaluated, and the derivatives are
//     needed
//     // for the evolution equations below.
  ...
  static void apply(
    ...
    for (size_t i = 0; i < 3; ++i) {
      ...
      Spectral::Swsh::swsh_derivatives<tmpl::list<Spectral::Swsh::Tags::Eth>>(
          l_max, 1, make_not_null(&derivative_buffer), buffer);
...
struct GaugeUpdateDuXtildeOfX {
  ...
  static void apply(
    ...
    omega_interpolator.interpolate(
        ...
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, du_omega_of_x_tilde),
            l_max)
            .data());

    u_interpolator.interpolate(
        make_not_null(&u_0_hat_of_x.data()),
        Spectral::Swsh::libsharp_to_goldberg_modes(
            Spectral::Swsh::swsh_transform(l_max, 1, get(*u_0_hat)), l_max)
            .data());
...
struct GaugeUpdateOmega {
  using argument_tags =
      tmpl::list<Tags::GaugeA, Tags::GaugeB, Spectral::Swsh::Tags::LMax>;
  using return_tags =
...
struct GaugeUpdateOmegaCD {
  ...
  static void apply(
    ...
    Spectral::Swsh::swsh_derivatives<tmpl::list<Spectral::Swsh::Tags::Eth>>(
        l_max, 1, make_not_null(&get(*eth_omega_cd)), get(*omega_cd));
  }
};
