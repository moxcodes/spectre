      ...
      Parallel::PhaseActions<
          ...
          tmpl::flatten<tmpl::list<
              ...
              tmpl::transform<typename Metavariables::scri_values_to_observe,
                              tmpl::bind<Actions::EnqueueInterpolationScriData,
                                         tmpl::_1>>>>>>;
...
SPECTRE_TEST_CASE(
    "Unit.Evolution.Systems.Cce.Actions.EnqueueInterpolationScriData",
    "[Unit][Cce]") {
  ...
  ActionTesting::MockRuntimeSystem<test_metavariables> runner{
      tuples::tagged_tuple_from_typelist<
          ...
          number_of_radial_points, scri_output_density}};
