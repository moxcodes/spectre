...
// in this test that was able to be omitted from the ComputePreSwshDerivatives
// test.
...
SPECTRE_TEST_CASE("Unit.Evolution.Systems.Cce.ComputeSwshDerivatives",
                  "[Unit][Evolution]") {
  ...
  using swsh_derivative_tag_list = tmpl::append<
      swsh_derivative_tags_to_compute_for<TestSpinWeightedScalar<0>>,
      second_swsh_derivative_tags_to_compute_for<TestSpinWeightedScalar<0>>,
      swsh_derivative_tags_to_compute_for<TestSpinWeightedScalar<1>>,
      second_swsh_derivative_tags_to_compute_for<TestSpinWeightedScalar<1>>>;
  ...
  auto expected_box = db::create<db::AddSimpleTags<
      Spectral::Swsh::Tags::LMax, boundary_value_variables_tag,
