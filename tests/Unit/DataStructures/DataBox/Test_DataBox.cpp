...
void test_mutate_assign() noexcept {
  ...
  db::mutate_assign<test_databox_tags::Tag2Base>(make_not_null(&box),
                                                 "new string value");
  CHECK(db::get<test_databox_tags::Tag2>(box) == "new string value");
  CHECK(db::get<test_databox_tags::Tag2Base>(box) == "new string value");
}
